...
# head returns the head or top of the table
head(crime)
tail(crime)
dim(crime)
colnames(crime)
...
par(mar=c(4,4,2.5,.5))
plot(uncorr_x, w.uncorr_x, xlab="Y ~ N(0, 1)", ylab="Spatial Lag of Y", 
     main=expression(symbol("\162") == 0),col="grey",cex=.5,xlim=c(-4,4),ylim=c(-4,4))
