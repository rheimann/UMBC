...
setwd("/Users/heimannrichard/Google Drive/Spatial Analysis UMBC/RCode")
...
my.key<- "szvyG67sOIIzbDBGjstbSA"
my.secret<- "DrYEuDr8KuDX5hSmuWICBy0JSrQzq5Vz5DSr7VIobZ4"
...
# handshake with cred
cred$handshake(cainfo="/Users/heimannrichard/Google Drive/Spatial Analysis UMBC/RCode/cacert.pem")

#Finally, save your authentication settings:  
save(cred, file="/Users/heimannrichard/Google Drive/Spatial Analysis UMBC/RCode/twitterauthentication.Rdata")
